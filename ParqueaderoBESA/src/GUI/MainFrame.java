...
public class MainFrame extends javax.swing.JFrame 
{
     ...
     */
    public MainFrame(ICallbackGUI _callback, int _size, int _numeroPisos) 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextCantidadCarros.setText("5");
        getContentPane().add(jTextCantidadCarros, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 280, 72, -1));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 330, -1, 30));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 280, -1, -1));

        jTextCantidadPeatones.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jTextCantidadPeatones.setText("3");
        getContentPane().add(jTextCantidadPeatones, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 330, 72, -1));
    ...
    private void jButtonIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIniciarActionPerformed
        ...
        try
        {
            ...
            int numeroOcupantes = Integer.parseInt(jTextCantidadCarros.getText());
