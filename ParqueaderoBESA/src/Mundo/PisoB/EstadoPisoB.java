 ...
 */
public class EstadoPisoB extends EstadoPiso
{
    public EstadoPisoB(int _size)
    {
        super(_size);
    }
    ...
    protected void InicializarMapa() 
    {
        ...
        listaElementosTemporal[2][1] = new ClassElemento("", TipoElemento.Calle, objCalleAbajo);  // Para entrar desde Piso+
        ...
        listaElementosTemporal[11][1] = new ClassElemento("", TipoElemento.Calle, objCalleArriba);  // Para salir hacia Piso+
