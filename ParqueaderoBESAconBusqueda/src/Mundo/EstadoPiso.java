...
public class EstadoPiso extends StateBESA {
    ...
    public static final Point puntoSalidaPisoArriba = new Point(0 * 4 - 1, 2 * 4);
    public static final Point puntoEntradaPisoArriba = new Point (0 * 4, 3 * 4);
    
    public static final Point puntoSalidaPisoAbajo = new Point (0 * 4 - 1, 10 * 4);
    public static final Point puntoEntradaPisoAbajo = new Point(0 * 4, 11 * 4); 
    ...
    public void CambiarCasilla(int posRelativaX, int posRelativaY, TipoElemento elemento, Object dato)
    {
        for (int i = posRelativaX * 4; i < posRelativaX * 4 + 4; i++)
        {
            for (int j = posRelativaY * 4; j < posRelativaY * 4 + 4; j++)
            {
                listaElementos[i][j] = new ClassElemento("", elemento, dato);
            }
        }
    }
    ...
    private void InicializarMapa() 
    {
        ...
        listaElementosTemporal[10][2] = new ClassElemento("", TipoElemento.Calle, objCalleIzquierdaAbajo);
        ...
        listaElementosTemporal[3][3] = new ClassElemento("", TipoElemento.Calle, objCalleDerechaArriba);
        ...
        listaElementosTemporal[0][10] = new ClassElemento("", TipoElemento.Calle, objCalleIzquierda);
    ...
    public int ObtenerNumeroPiso(String nombrePiso)
    {
        String [] tokens = nombrePiso.split("_");
        int numeroPiso;
        
        if (tokens.length == 1)
            numeroPiso = 1;
        else
            numeroPiso = Integer.parseInt(tokens[1]);
        
        return numeroPiso;
    }
    
    public String ObtenerNombrePiso(int numeroPiso)
    {
        String nombrePiso = "WORLD";
        if (numeroPiso > 1)
        {
            nombrePiso = nombrePiso + "_" + numeroPiso;
        }
