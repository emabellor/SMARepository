...
public class ClassTreeNode
{
    ...
    public void setEstadoI(int Ci)
    {
        this.nodoArbol[2] = Ci;
    }
    
    public void setEstadoJ(int Cj)
    {
        this.nodoArbol[3] = Cj;
    }
    ...
    public void setHijo1(int h1)
    {
        this.nodoArbol[5] = h1;
    }
    
    public void setHijo2(int h2)
    {
        this.nodoArbol[6] = h2;
    }
    
    public void setHijo3(int h3)
    {
        this.nodoArbol[7] = h3;
    }
    
    public void setHijo4(int h4)
    {
        this.nodoArbol[8] = h4;
    }
