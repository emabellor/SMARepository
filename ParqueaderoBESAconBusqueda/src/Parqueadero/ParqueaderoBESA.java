...
public class ParqueaderoBESA 
{
    ...
    public static void main(String[] args) 
    {
        ...
        mainFrame = new MainFrame(callback, MAP_SIZE);
    ...
    static void InicializarAgentes (ClassParametrosSimulacion parametros) throws BESA.ExceptionBESA 
    {
        ...
        for (int i = 1; i <= parametros.numeroPisos; i++)
        {
            ...
            structPisoA.bindGuard(nombreBehavior, GuardaIngresarCarroMundoResult.class);
        ...
        EstadoViewer estadoViewer = new EstadoViewer(callbackViewer, parametros.numeroPisos);
